...
import { FaPlus, FaCalendarAlt, FaImage, FaPenAlt, FaStar, FaRocket, FaUpload, FaSpinner } from 'react-icons/fa';
...
const CreateAssignment = () => {
  ...
  const handleCreateAssignment = (e) => {
    ...
    assignment.thumbnail = imageUrl; // Use the uploaded image URL
    assignment.creatorEmail = user?.email || 'unknown';
    assignment.creatorName = user?.displayName || 'Anonymous';

    // Remove the file input from the assignment object since we're using imageUrl
      ...
      .then((res) => {
        if (res.data.insertedId) {
          Swal.fire({
            ...
            text: 'Your assignment has been published to the platform',
            icon: 'success',
            confirmButtonColor: '#6366f1',
            background: '#1f2937',
            color: 'white'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8 px-4">
      <Helmet>
        <title>Create Assignment - BrainBand</title>
      </Helmet>
      ...
      >
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Design engaging assignments that inspire learning and collaboration among students
          </p>
        </motion.div>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 px-8 py-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Fill in all the required information</p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <input
                      ...
                      type="number"
                      placeholder="100"
                      className="w-full px-4 py-4 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 transition-all duration-300 shadow-sm"
                      required
                    />
                  </motion.div>
          ...
          >
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl p-6 border border-white/20 dark:border-gray-700/50 shadow-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-semibold text-gray-800 dark:text-gray-200">Assignment Tips</h3>
              </div>
              <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-300">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Set realistic deadlines for submissions
                </li>
                <li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Include relevant image for better engagement
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-6 text-white shadow-xl">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-semibold">Image Requirements</h3>
              </div>
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                  <span>Auto-upload to cloud</span>
                </div>
              </div>
            </div>
          </motion.div>
